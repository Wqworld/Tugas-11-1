...
<body class="bg-white dark:bg-gray-900 font-bold my-50">
    <h1 class="text-center text-5xl text-white mb-4">Update Data Siswa</h1>


    <form class="max-w-md mx-auto" method="POST" action="{{ route('siswa.update', ['id'=>$siswa->id]) }}">
      @csrf
      @method('PUT')
        <div class="relative z-0 w-full mb-5 group">
            <input type="text" name="nama_siswa" id="floating_email"
        ...
        <label for="countries" class="block mb-2 text-sm font-medium text-gray-500 dark:text-gray-400">Status</label>
